function montage = montageImages(Data_dir0,save)
...
Data_dir = strcat(Data_dir0,'\Channels'); % Data Directory
...
% montage(mosaics, 'Size', [1 n_channels]);
    ...
    if save==1
        imwrite(mosaics, 'C:\Users\ACER\Documents\ULPGC\TFM\02_CODIGOS\Data\montages\Mosaic.tif');
        imwrite(mosaics, strcat(Data_dir0, '\Mosaic.tif'));
    else
        imwrite(mosaics(:,:,3), strcat(Data_dir0, '\Mosaic.tif'));
    end
    montage = mosaics;
    fprintf('Stitch Finished!\n');
end