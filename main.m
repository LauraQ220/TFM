...
%     B = 'montage';
    [ground_Truth, montage] = removeBorder(single_test_dir, ground_Truth, montage, frames(i), overlap(i), overlap(i), want2save,want2show);
    ground_Truth_double = im2double(ground_Truth);
    ...
    fprintf('PSNR = %.2f dB(The higher the better)\n',psnrVal(i));  
    ssimVal(i) = ssimFun(montage_double,ground_Truth_double);
    fprintf('SSIM = %.2f (0: no correlation, 1:equal images)\n',ssimVal(i));
